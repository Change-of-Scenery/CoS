...
public class BadgeHub: NSObject {
    ...
    private struct Constants {
        ...
        static let popOutRatio: CGFloat = 1.5
        static let popInRatio: CGFloat = 0.95
        // Blink values
        static let blinkDuration: CGFloat = 0.1
        static let blinkAlpha: CGFloat = 0.1
        // Bump values
        static let firstBumpDistance: CGFloat = 4.0
        static let bumpTimeSeconds: CGFloat = 0.3
        static let secondBumpDist: CGFloat = -10.0
        static let bumpTimeSeconds2: CGFloat = 0.25
    }
    ...
    public func setView(_ view: UIView?, andCount startCount: Int) {
      ...
      redCircle.backgroundColor = UIColor(named: "LaunchBackgroundColor")
      ...
      let atFrame = CGRect(x: Constants.badgeX, y: Constants.badgeY,
